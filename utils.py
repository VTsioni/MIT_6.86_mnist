...
def get_MNIST_data():
    ...
    """
    train_set, valid_set, test_set = read_pickle_data('C:\\Users\\vasts\\Documents\\MIT\\MIT Statistics and Data Science\\mit686sup\\2\\resources_mnist\\mnist\\Datasets\\mnist.pkl.gz')
